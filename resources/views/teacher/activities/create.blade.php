...
<div class="container mx-auto p-6 max-w-4xl bg-white shadow-md rounded-lg">
    ...
    <form action="{{ route('activities.store') }}" method="POST">
        ...
        <div class="mb-4">
            <label for="subject_id" class="block text-gray-700">Subject and Section</label>
        ...
        <div class="mb-4">
            <label for="activity_name" class="block text-gray-700">Activity Name</label>
        ...
        <div class="mb-4">
            <label for="activity_description" class="block text-gray-700">Activity Description</label>
        ...
        <div class="mb-4">
            <label for="activity_percent" class="block text-gray-700">Activity Percent</label>
        ...
        <h3 class="text-xl font-semibold mb-2">Criteria</h3>
        <div id="criteria-container">
            <div class="criteria-item mb-4">
                <div class="mb-4">
                    <label for="criteria[0][criterion_name]" class="block text-gray-700">Criteri on Name</label>
                ...
                <div class="mb-4">
                    <label for="criteria[0][criterion_percent]" class="block text-gray-700">Criteri on Percent</label>
        ...
        <button type="button" id="add-criterion" class="btn btn-secondary bg-gray-500 text-white py-2 px-4 rounded hover:bg-gray-700">Add Criterion</button>

        <button type="submit" class="btn btn-primary bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700">Create Activity</button>
    </form>
</div>
...
<script>
    document.getElementById('add-criterion').addEventListener('click', function () {
        ...
        newCriterion.innerHTML = `
            <div class="mb-4">
                <label for="criteria[${criterionCount}][criterion_name]" class="block text-gray-700">Criterion Name</label>
            ...
            <div class="mb-4">
                <label for="criteria[${criterionCount}][criterion_percent]" class="block text-gray-700">Criterion Percent</label>
